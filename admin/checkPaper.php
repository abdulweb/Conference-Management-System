...
$email = 'binraheem01@gmail.com';
$apiKey = '99E60992-341A-4581-9863-F4645FB47C60';
...
try{
	...
	//$process  = $clCloud->createByURL("https://www.copyleaks.com", $additionalHeaders);
	 //$process  = $clCloud->createByText($txt);
	$process = $clCloud->createByFile($rebrand, $additionalHeaders);
