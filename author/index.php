                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="card-box widget-box-two widget-two-info">
                                    ...
                                    <div class="wigdet-two-content text-white">
                                        ...
                                        <h2 class="text-white"><span data-plugin="counterup"><?= mysqli_num_rows(mysqli_query($con,"select * from upload_document where email = '".$_SESSION['user']."'")) ?></span> <small><i class="mdi mdi-arrow-up text-success"></i></small></h2>
